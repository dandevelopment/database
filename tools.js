...
function notify(message){
    ...
    document.body.innerHTML = '<div style="width:30%;background-color:#4f4f4f;border-radius:10px;color:white;boxShadow:0 8px 16px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);position:absolute;bottom:10px;right:0px;padding-top:20px;padding-bottom:20px;">' + message + '</div>' + document.body.innerHTML
}
